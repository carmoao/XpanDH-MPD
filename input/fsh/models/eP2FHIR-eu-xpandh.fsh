// -------------------------------------------------------------------------------					
//  Concept Model. File: 					eP2FHIR-eu-xpandh.fsh
// -------------------------------------------------------------------------------					
Instance: eP2FHIR-eu-xpandh					
...
* group[=].target = "http://hl7.eu/fhir/ig/xpandh-mpd/StructureDefinition/MedicationRequest-eu-xpandh"					
...
* group[+].source = "http://hl7.eu/fhir/ig/xpandh-mpd/StructureDefinition/Prescription"					
* group[=].target = "http://hl7.eu/fhir/ig/xpandh-mpd/StructureDefinition/Practictioner-eu-xpandh"					
